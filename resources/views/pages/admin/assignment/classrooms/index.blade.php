<x-main-layout>
    <div class="flex justify-between items-center">
        <x-page.header title="Classroom Assignment" />
    </div>
        ...
        <tbody>
            @foreach ($classrooms as $index => $classroom)
                <tr>
                    ...
                    <x-table.td :trPosition="$loop->last">{{$classroom['adviser']}}</x-table.td>
