                ...
                <div class="form-input-container">
                    ...
                    <select class="form-input" name="honorific_id" id="honorific_id">
                        ...
                        @foreach ($honorifics as $honorific)
                            <option value="{{$honorific->id}}" @if ($honorific->id == $teacher->honorific_id) selected @endif>{{$honorific->honorific}}</option>
                        @endforeach
                    </select>
            ...
            <div class="flex flex-row justify-between">
                ...
                <div class="form-input-container">
                    ...
                    <select class="form-input" name="is_adviser" id="is_adviser">
                        <option value="1" @if ($isAdviser) selected @endif>Yes</option>
                        <option value="0" @if (!$isAdviser) selected @endif>No</option>
                    </select>
