...
<div {{$attributes->class([
    ...
    <div aria-expanded="false" class="teacher_select_dropdown_body absolute mt-2 z-10 bg-white overflow-y-hidden max-h-0 aria-expanded:max-h-[100rem] transition-all">
        {{$slot}}
    </div>
</div>
