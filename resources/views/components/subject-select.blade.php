...
<div {{$attributes->class([
    'subject-select-dropdown w-full relative hover:bg-gray-200 duration-100 rounded-lg'
])}}>
    {{-- @dd($fetchedSubject) --}}
    ...
    <div aria-expanded="false" class="subject_select_dropdown_body absolute left-0 top-[100%] z-10 bg-project-gray-light overflow-y-hidden max-h-0 aria-expanded:max-h-[100rem] transition-all flex justify-center flex-col gap-2 w-full">
