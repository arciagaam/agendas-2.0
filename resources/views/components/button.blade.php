@props(['label' => '', 'icon' => '', 'size' => 'md', 'type' => 'primary', 'id' => ''])
...
{{$attributes->class([
    ...
    'bg-white text-project-primary-600 ring-1 ring-project-gray-default fill-project-primary-600 hover:ring-project-accent-400 hover:text-project-accent-400 hover:fill-project-accent-400' => $type == 'secondary',
